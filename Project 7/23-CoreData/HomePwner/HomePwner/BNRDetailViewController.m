...
@property (weak, nonatomic) IBOutlet UIBarButtonItem *roomButton;

- (IBAction)takePicture:(id)sender;
- (IBAction)backgroundTapped:(id)sender;
- (IBAction)showAssetTypePicker:(id)sender;
- (IBAction)showAssetLocationPicker:(id)sender;
@end
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //This is for the room values:
    NSString *typLabel = [self.item.assetType valueForKey:@"label"];
    {
        if (!typLabel) {
            typLabel = @"None";
        }
    ...
    self.roomButton.title = [NSString stringWithFormat:@"Room: %@", typLabel];
    }
    [self updateFonts];
}
...
- (IBAction)showAssetLocationPicker:(id)sender {
    ...
    BNRAssetLocation *location = [[BNRAssetLocation alloc] init];
